...
export default async function SignupPage({
  ...
  if (host.includes('localhost')) {
    ...
    if (host.includes('.')) {
      ...
      // No subdomain, redirect to main signup
    ...
    <div className={`min-h-screen bg-gradient-to-br ${tenant.themeConfig.gradients.hero}`}>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <a 
                href={`/?lang=${tenant.currentLanguage}`}
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          <Card className="border-0 shadow-xl" style={{ backgroundColor: tenant.themeConfig.colors.surface }}>
